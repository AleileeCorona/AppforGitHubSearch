...
const apiKey = "33d3004ce97716e05ac2df17a2eee090b0e39786";

const searchURL = 'https://developer.github.com/user/repo';
...
function getGithub(query, maxResults=10) {
  const params = {
    q: query,
    pageSize: maxResults
  };
...
function watchForm() {
  $('form').submit(event => {
    ...
    getGithub (searchTerm, maxResults);
  });
}
